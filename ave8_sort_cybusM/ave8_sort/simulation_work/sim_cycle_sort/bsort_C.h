...
checksum : 00002f885a7acc152223431eaafc14aa05dd2864da27e633
...
#ifndef NO_MAIN
class sort_SA_test : public sc_module {
 public:
    // IO
    sc_in<bool > bus1_HCLK;
    sc_out<sc_uint<1> > bus1_HRESETn;
    sc_out<sc_uint<32> > sort_SA_bus1_CBM_addr;
    sc_out<sc_uint<3> > sort_SA_bus1_CBM_size;
    sc_in<sc_uint<32> > sort_SA_bus1_CBM_read_data;
    sc_in<sc_uint<1> > sort_SA_bus1_CBM_busy;
    sc_in<sc_uint<1> > sort_SA_bus1_CBM_error;
    sc_in<sc_uint<1> > sort_SA_bus1_CBM_retry;
    sc_in<sc_uint<1> > sort_SA_bus1_CBM_split;
    sc_out<sc_uint<1> > sort_SA_bus1_CBM_read_req;
    sc_out<sc_uint<1> > sort_SA_bus1_CBM_write_req;
    sc_out<sc_uint<32> > sort_SA_bus1_CBM_write_data;
    ...
    struct sort_SA &Cysim_main_dut;
    // input temporary value
    // File pointer
    ofstream Cysim_of_sort_SA_bus1_CBM_addr;
    ofstream Cysim_of_sort_SA_bus1_CBM_size;
    ofstream Cysim_of_sort_SA_bus1_CBM_read_data;
    ofstream Cysim_of_sort_SA_bus1_CBM_busy;
    ofstream Cysim_of_sort_SA_bus1_CBM_error;
    ofstream Cysim_of_sort_SA_bus1_CBM_retry;
    ofstream Cysim_of_sort_SA_bus1_CBM_split;
    ofstream Cysim_of_sort_SA_bus1_CBM_read_req;
    ofstream Cysim_of_sort_SA_bus1_CBM_write_req;
    ofstream Cysim_of_sort_SA_bus1_CBM_write_data;
    ofstream Cysim_of_out_sorted;
    // constructor
    SC_HAS_PROCESS(sort_SA_test);
    sort_SA_test(sc_module_name name_, struct sort_SA &dut);
};
#endif // !NO_MAIN
